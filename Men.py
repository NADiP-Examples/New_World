...
class Men():
    ...
    # Основные параметры персонажа
        ...
        self.gear = {                           # Снаряжение
                "Outerwear" : load_image("White_doc_robe.png", alpha_cannel="True"),    # Куртка\Костюм
                    }
        self.skills = {                         # Навыки
                "magic"     : 1,                                                        # Магия
                "strength"  : 1,                                                        # Сила
    ...
    def img_designer(self):
        '''
                Собирает картинку из частей, поворачивает на нужный угол, вклеивает на поверхность 100х100 пикселей (размер тайла)
        '''
    ...
    def render(self,screen, coof):
        screen.blit(self.ren_img, (self.cor[0]*100+coof[0]+self.move_progress[0],self.cor[1]*100+coof[1]+self.move_progress[1]))